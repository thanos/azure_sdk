defmodule ExAzure.Core.Response do
  @moduledoc """
  Normalized HTTP response returned by the ExAzure pipeline.
  """
  ...
  @type t :: %__MODULE__{
          ...
          headers: map(),
          body: binary() | nil,
          request: ExAzure.Core.Request.t() | nil
        }
  ...
  """
  @spec from_req(Req.Response.t(), ExAzure.Core.Request.t() | nil) :: t()
